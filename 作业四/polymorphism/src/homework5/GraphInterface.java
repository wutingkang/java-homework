...
public class GraphInterface implements ActionListener{
		...
		if (cmd.equals("CommisionEmployee"))
		{
			...
			sunmitButton.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					...
					CommisionEmployee newCommisionEmployee = new CommisionEmployee(
			...
			sunmitButton.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent e) {
					...
					double commissionRate = Double.parseDouble(commissionRateText.getText().toString());
					BasePlusCommisionEmployee newBasePlusCommisionEmployee = new BasePlusCommisionEmployee(
							firstNameText.getText().toString(),
							lastNameText.getText().toString(),
							socialSecurityNumberText.getText().toString(),
							grossSales,
			...
			//使用下面的方式更简单，但这是作业，用上面的方式是为了熟悉Iterator的用法
